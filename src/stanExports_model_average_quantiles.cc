...
#include "stanExports_model_average_quantiles.h"

RCPP_MODULE(stan_fit4model_average_quantiles_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_model_average_quantiles")
