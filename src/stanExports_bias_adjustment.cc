...
#include "stanExports_bias_adjustment.h"

RCPP_MODULE(stan_fit4bias_adjustment_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bias_adjustment")
