...
ensemble. Models are stacked according to the Continuous Ranked Probability 
Score (CRPS) based on predictive samples. 
...
Weights are generated using the `crps_weights` function. With these weights and predictive samples, the `mixture_from_samples` function can be used to obtain 
